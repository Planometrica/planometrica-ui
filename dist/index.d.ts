...
declare const colors: {
    readonly brand: {
        readonly primary: "#0A4C76";
        readonly secondary: "#1A7BB3";
        readonly green: "#92CF93";
        readonly orange: "#F59E0B";
    };
    readonly light: {
        readonly background: "#FFFFFF";
        readonly foreground: "#0A4C76";
        readonly card: "#FFFFFF";
        readonly cardForeground: "#0A4C76";
        readonly popover: "#FFFFFF";
        readonly popoverForeground: "#0A4C76";
        readonly primary: "#0A4C76";
        readonly primaryForeground: "#F0F9FF";
        readonly secondary: "#F0F9FF";
        readonly secondaryForeground: "#0A4C76";
        readonly muted: "#F0F9FF";
        readonly mutedForeground: "#64748B";
        readonly accent: "#F0F9FF";
        readonly accentForeground: "#0A4C76";
        readonly destructive: "#EF4444";
        readonly destructiveForeground: "#FFFFFF";
        readonly border: "#E2E8F0";
        readonly input: "#E2E8F0";
        readonly ring: "#0A4C76";
    };
    readonly dark: {
        ...
        readonly muted: "#334155";
        readonly mutedForeground: "#94A3B8";
        readonly accent: "#334155";
        readonly accentForeground: "#F8FAFC";
 ...
 */
declare const hslColors: {
    readonly brandPrimary: "203 83% 25%";
    readonly brandSecondary: "201 73% 40%";
    readonly background: "0 0% 100%";
    readonly foreground: "203 83% 25%";
    readonly card: "0 0% 100%";
    readonly cardForeground: "203 83% 25%";
    readonly popover: "0 0% 100%";
    readonly popoverForeground: "203 83% 25%";
    readonly primary: "203 83% 25%";
    readonly primaryForeground: "200 100% 97%";
    readonly secondary: "200 100% 97%";
    readonly secondaryForeground: "203 83% 25%";
    readonly muted: "200 100% 97%";
    readonly mutedForeground: "215 16% 47%";
    readonly accent: "200 100% 97%";
    readonly accentForeground: "203 83% 25%";
    readonly destructive: "0 84% 60%";
    readonly destructiveForeground: "0 0% 100%";
    readonly border: "214 32% 91%";
    readonly input: "214 32% 91%";
    readonly ring: "203 83% 25%";
    readonly radius: "0.5rem";
};
type ColorToken = keyof typeof colors;
type BrandColor = keyof typeof colors.brand;
type LightThemeColor = keyof typeof colors.light;
type DarkThemeColor = keyof typeof colors.dark;
...
type FontFamily = keyof typeof fonts.families;
type FontSize = keyof typeof fonts.sizes;
type FontWeight = keyof typeof fonts.weights;
...
declare const buttonVariants: (props?: ({
    variant?: "link" | "default" | "destructive" | "outline" | "secondary" | "accent" | "ghost" | null | undefined;
...
type LogoVariant = 'primary' | 'inverse' | 'transparent';
interface PlanometricaLogoProps extends React$1.SVGAttributes<SVGSVGElement> {
    /**
     * Logo color variant:
 ...
 */
declare const PlanometricaLogo: React$1.ForwardRefExoticComponent<PlanometricaLogoProps & React$1.RefAttributes<SVGSVGElement>>;

export { Accordion, AccordionContent, AccordionItem, AccordionTrigger, Alert, AlertDescription, AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogOverlay, AlertDialogPortal, AlertDialogTitle, AlertDialogTrigger, AlertTitle, AspectRatio, Avatar, AvatarFallback, AvatarImage, Badge, type BadgeProps, type BrandColor, Breadcrumb, BreadcrumbEllipsis, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbPage, BreadcrumbSeparator, Button, type ButtonProps, Calendar, type CalendarProps, Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle, Carousel, type CarouselApi, CarouselContent, CarouselItem, CarouselNext, CarouselPrevious, type ChartConfig, ChartContainer, ChartLegend, ChartLegendContent, ChartStyle, ChartTooltip, ChartTooltipContent, Checkbox, Collapsible, CollapsibleContent, CollapsibleTrigger, type ColorToken, Command, CommandDialog, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, CommandSeparator, CommandShortcut, ContextMenu, ContextMenuCheckboxItem, ContextMenuContent, ContextMenuGroup, ContextMenuItem, ContextMenuLabel, ContextMenuPortal, ContextMenuRadioGroup, ContextMenuRadioItem, ContextMenuSeparator, ContextMenuShortcut, ContextMenuSub, ContextMenuSubContent, ContextMenuSubTrigger, ContextMenuTrigger, type DarkThemeColor, Dialog, DialogClose, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogOverlay, DialogPortal, DialogTitle, DialogTrigger, Drawer, DrawerClose, DrawerContent, DrawerDescription, DrawerFooter, DrawerHeader, DrawerOverlay, DrawerPortal, DrawerTitle, DrawerTrigger, DropdownMenu, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuLabel, DropdownMenuPortal, DropdownMenuRadioGroup, DropdownMenuRadioItem, DropdownMenuSeparator, DropdownMenuShortcut, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger, DropdownMenuTrigger, type FontFamily, type FontSize, type FontWeight, Form, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage, HoverCard, HoverCardContent, HoverCardTrigger, Input, InputOTP, InputOTPGroup, InputOTPSeparator, InputOTPSlot, Label, type LightThemeColor, type LogoVariant, Menubar, MenubarCheckboxItem, MenubarContent, MenubarGroup, MenubarItem, MenubarLabel, MenubarMenu, MenubarPortal, MenubarRadioGroup, MenubarRadioItem, MenubarSeparator, MenubarShortcut, MenubarSub, MenubarSubContent, MenubarSubTrigger, MenubarTrigger, NavigationMenu, NavigationMenuContent, NavigationMenuIndicator, NavigationMenuItem, NavigationMenuLink, NavigationMenuList, NavigationMenuTrigger, NavigationMenuViewport, Pagination, PaginationContent, PaginationEllipsis, PaginationItem, PaginationLink, PaginationNext, PaginationPrevious, PlanometricaLogo, type PlanometricaLogoProps, Popover, PopoverAnchor, PopoverContent, PopoverTrigger, Progress, RadioGroup, RadioGroupItem, ResizableHandle, ResizablePanel, ResizablePanelGroup, ScrollArea, ScrollBar, Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectScrollDownButton, SelectScrollUpButton, SelectSeparator, SelectTrigger, SelectValue, Separator, Sheet, SheetClose, SheetContent, SheetDescription, SheetFooter, SheetHeader, SheetOverlay, SheetPortal, SheetTitle, SheetTrigger, Sidebar, SidebarContent, SidebarFooter, SidebarGroup, SidebarGroupAction, SidebarGroupContent, SidebarGroupLabel, SidebarHeader, SidebarInput, SidebarInset, SidebarMenu, SidebarMenuAction, SidebarMenuBadge, SidebarMenuButton, SidebarMenuItem, SidebarMenuSkeleton, SidebarMenuSub, SidebarMenuSubButton, SidebarMenuSubItem, SidebarProvider, SidebarRail, SidebarSeparator, SidebarTrigger, Skeleton, Slider, Toaster$1 as Sonner, Switch, Table, TableBody, TableCaption, TableCell, TableFooter, TableHead, TableHeader, TableRow, Tabs, TabsContent, TabsList, TabsTrigger, type TextStyle, Textarea, Toast$1 as Toast, ToastAction, type ToastActionElement, ToastClose, ToastDescription, type ToastProps, ToastProvider, ToastTitle, ToastViewport, Toaster, Toggle, ToggleGroup, ToggleGroupItem, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger, badgeVariants, buttonVariants, cn, colors, fonts, formatArea, formatCurrency, formatNumber, formatPercentage, formatVolume, hslColors, navigationMenuTriggerStyle, textStyles, toast, toggleVariants, useFormField, useIsMobile, useSidebar, useToast };
